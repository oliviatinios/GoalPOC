package poc.eventstore.examples.todolist.todoservice.backend;
...
import poc.eventstore.examples.todolist.todoservice.backend.domain.TodoAggregate;
import poc.eventstore.examples.todolist.todoservice.backend.domain.TodoBulkDeleteAggregate;
import poc.eventstore.examples.todolist.todoservice.backend.domain.TodoEventSubscriber;
...
@Configuration
@EntityScan("poc.eventstore.examples.todolist")
@EnableJpaRepositories("poc.eventstore.examples.todolist")
@EnableEventHandlers
